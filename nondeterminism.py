...
# combine the injection of the return values of the computations of
# function, starting from start and stopping when shorcircuit by stop;
# finally, return postprocess applied to the accumulator
